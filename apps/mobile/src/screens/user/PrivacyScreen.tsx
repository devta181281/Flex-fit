...
export default function PrivacyScreen() {
    ...
    const sections = [
        ...
        },
        {
            ...
            content: 'We may collect location data to show nearby gyms when you use the search feature. You can disable location services in your device settings at any time.',
        },
        {
